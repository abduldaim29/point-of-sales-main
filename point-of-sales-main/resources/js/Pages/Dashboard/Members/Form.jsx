            ...
            <div className="w-full">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        {isEdit
                            ? "Manage member status, tier, and basic data without affecting transaction or reward history."
                            : "Register the customer as a member to immediately receive points, member pricing benefits, and personal vouchers."}
                    </p>
                </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-xs leading-6 text-slate-600 dark:text-slate-300">
                                    Members automatically use special member pricing, earn/redeem points from loyalty settings, and can receive personal vouchers in CRM.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400">
                                    Complete the member's basic information for CRM search and history.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400">
                                        Deactivate the member if member benefits should be paused without deleting history.
                                    </p>
                                </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                        ...
                        <div className="mt-4">
                            <Textarea
                                ...
                                placeholder="Member full address"
